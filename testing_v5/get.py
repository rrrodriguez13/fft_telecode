...
import numpy as np
from fft_telescope.code1.testing_v5.functions_test import receive, writeto, initialize_plots, update_plot, correlate_and_plot

# Configuration
IP_ADDRESSES = ["10.10.10.60", "10.10.10.50"]
PORTS = [6373, 6372]  # Different ports for each IP
DATA_QUEUE_SIZE = 10
